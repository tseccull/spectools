...
###############################################################################
def save_gmos(file_name, in_file, primary_header, cMask, cleanSci, dCParams, commandArgs):
	'''
	...
	qualHead = in_file["DQ"].header
	qualData = in_file["DQ"].data + cMask
